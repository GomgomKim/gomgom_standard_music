...
import com.example.gomgom_standard_music.item.CommentListItem;
...
public class CommentListAdapter extends BaseAdapter{
    ...
    private ArrayList<CommentListItem> mItems = new ArrayList<>();
    ...
    public void addItem(String user_name, String date, String comment_text, String comment_img, int heart, int like_count){
        CommentListItem mItem = new CommentListItem();
