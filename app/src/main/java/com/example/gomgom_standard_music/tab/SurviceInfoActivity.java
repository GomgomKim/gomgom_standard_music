...
public class SurviceInfoActivity extends AppCompatActivity {
    ...
    public void terms_popup_window(View v){
        ...
        String terms="";
        try {
            inputStream = am.open("assign.txt");
    ...
    public void send_mail(){
        ...
        email.putExtra(Intent.EXTRA_TEXT, "어플리케이션 : She's a Baby\n"+
                "기기 종류 : "+phone_name+"\n"+
                "OS 버전 : "+user_os_version+"\n"+
                "앱 버전 : 1.3"+"\n"+
                "음반 정보 : She's a Baby (지코(ZICO)).\n");
        startActivity(email);
